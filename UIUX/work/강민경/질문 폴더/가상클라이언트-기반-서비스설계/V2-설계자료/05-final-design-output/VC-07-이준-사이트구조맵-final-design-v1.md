# VC-07 이준-사이트구조맵 final design v1
...
A/B/C comparison
A products: PROD-015, PROD-031, PROD-071
B products: PROD-015, PROD-031, PROD-071
C products: PROD-015, PROD-031, PROD-071
Common products: PROD-015, PROD-031, PROD-071
Merged products: 
REQ: REQ-007
...
Sources
Source folder: VC-07-이준-사이트구조맵-V3
A/B/C V3 MD MMD SVG
...
- A source: VC-07-이준-사이트구조맵-A안-V3-사이트맵.md
...
- B source: VC-07-이준-사이트구조맵-B안-V3-사이트맵.md
...
- C source: VC-07-이준-사이트구조맵-A안-V3-사이트맵.md
  Sections: ## 10. ?섏젙??V5 ?낅젰 寃利씲톅3 ?ъ깮?? / ## 1. Client ?꾩껜 遺꾩꽍 / ## 2. ?붽뎄 ??硫붾돱쨌肄섑뀗痢졖룰린?? / ## 3. 援ъ“?댟룹궗?댄듃留? / ## 4. ?섏씠吏쨌?먮쫫쨌寃利? / ## 5. Mermaid / ## 6. 異붿쟻 / ## 援ъ“ ?꾨왂 (?쒖? 蹂댁셿) / ## ?ъ슜???먮쫫쨌?곹깭 (?쒖? 蹂댁셿) / ## 以묐났쨌?딄?쨌媛??寃利?(?쒖? 蹂댁셿) / ## ?먯젙 (?쒖? 蹂댁셿) / ## Client쨌REQ 異붿쟻 (?쒖? 蹂댁셿)
...
- B products: PROD-015, PROD-031, PROD-071
- C products: PROD-015, PROD-031, PROD-071
- Final union: PROD-015, PROD-031, PROD-071
